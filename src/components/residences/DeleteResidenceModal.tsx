import { deleteResidence } from '@/api/ResidenceAPI';
...
type DeleteResidenceModalProps = {
  id: number;
  setIsOpen: (isOpen: boolean) => void;
};

export default function DeleteResidenceModal({ id, setIsOpen }: DeleteResidenceModalProps) {
