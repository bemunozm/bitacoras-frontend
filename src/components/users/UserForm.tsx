...
export function UserForm({setIsOpen}: UserFormProps) {
    ...
    const [selectedImage, setSelectedImage] = useState<FileWithPreview | undefined>(undefined)
    ...
    if(isLoadingRoles) return <LoadingSpinner className="h-10"/>
